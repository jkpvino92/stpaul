...
class CatewithimgWidget extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    */
    ...
    public function getCategoryParentUrl()
    {
        $rootCat = $this->getData('parentcat');


        $category = $this->categoryRepository->get($rootCat, $this->_storeManager->getStore()->getId());

        return $category->getUrl();

//        $categoryObj = $this->categoryRepository->get($rootCat);
//        $catRootUrl =  $this->categoryHelper->getCategoryUrl($categoryObj);
//        return $catRootUrl;
    }
}