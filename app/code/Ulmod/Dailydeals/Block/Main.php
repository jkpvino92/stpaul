...
class Main extends \Magento\Catalog\Block\Product\AbstractProduct
{
    ...
    {
        return $this->configModel->getDescription();
    }
    ...
    {
        return $this->configModel->getcurrencySymbol();
    }
	
    /**
     * Check if is Show Countdown
     *
     * @return bool
     */	
    public function isShowCountdown()
    {
        return $this->configModel->isShowCountdown();
    }
    ...
    {
        return $this->configModel->getCountdownLabel();
    }
