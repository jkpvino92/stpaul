        ...
        _onPropertyChange: function () {
            ...
            if (value.length >= parseInt(this.options.minSearchLength, 10)) {
                ...
                this.request = $.get(this.options.url, {q: value}, $.proxy(function (data) {
                    ...
                    if( ! data.length)
                        dropdown.find('.c-smartsearch__content').append('<div class="c-smartsearch__product no-product col-8-8"><p class="no-product-smartsearch">' + $.mage.__('No products found.') + '</p></div>');
