...
return [
    'modules' => [
        ...
        'Amasty_Geoip' => 1,
        'Amasty_PushNotifications' => 0,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Apptrian_FacebookPixel' => 1,
        'Aune_Stripe' => 1,
        'Creatuity_CustomMaintenance' => 1,
        'Custom_Field' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dotdigitalgroup_Sms' => 1,
        'Emizentech_CategoryWidget' => 1,
        'Igorludgero_Socialshare' => 1,
        ...
        'Meetanshi_DeleteOrder' => 1,
        'Meetanshi_Flatshipping' => 1,
        'Meetanshi_PayshipRestriction' => 1,
        'Mexbs_ProductAttributesMassAction' => 1,
        'Mirasvit_Blog' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'ProgrammingAtKstark_CatewithimgWidget' => 1,
        'Sebwite_SmartSearch' => 1,
        'Smaex_CustomerGroupPayments' => 1,
        'Staempfli_Seo' => 0,
